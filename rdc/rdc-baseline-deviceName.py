...
# desired_capabilities['deviceName'] = 'HTC U11'
desired_capabilities['deviceName'] = 'HTC_U11_support'
...
try:
    ...
    print("Test", driver.capabilities['name'], " obtained device: ", driver.capabilities['testobject_device_name'])
